...
// pub async fn apply_ruleset<P: Driver>(
//     nftables: &Nftables<'_>,
//     program: Option<&str>,
//     args: Option<Vec<&str>>,
...
// pub async fn apply_ruleset_raw<P: Driver>(
//     payload: String,
//     program: Option<&str>,
//     args: Option<Vec<&str>>,
// ) -> Result<(), NftablesError> {
...
// pub async fn get_current_ruleset<P: Driver>(
//     program: Option<&str>,
//     args: Option<Vec<&str>>,
...
// pub async fn get_current_ruleset_raw<P: Driver>(
//     program: Option<&str>,
//     args: Option<Vec<&str>>,
